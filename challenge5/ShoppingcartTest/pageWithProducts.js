...
addToCartButtonsDOM.forEach(addToCartButtonDOM => {
  addToCartButtonDOM.addEventListener('click', () => {
    ...
    addProductToDb(event.target.id);
    const productDOM = addToCartButtonDOM.parentNode;
    const product = {
...
function addProductToDb(id) {
  ...
  xhttp.open("GET", "ShoppingcartTest/addproducttodb.php?id=" + id + "&count=" + count, true);
...
function checkout() {
  let paypalFormHTML = `
    <form id="paypal-form" action="paypal.me/mxntyz" method="post">
      <input type="hidden" name="cmd" value="_cart">
      <input type="hidden" name="upload" value="1">
      <input type="hidden" name="business" value="mxntyz@hotmail.com">
  `;
